...
import { INDIGO, VIOLET, CYAN, SLATE, EMERALD, AMBER, ROSE, SKY } from './primitives';
...
export const SEMANTIC_COLORS_LIGHT: SemanticColorPalette = {
  primary: {
    ...
    DEFAULT: INDIGO[500],
    dark: INDIGO[600],
    contrast: { hex: '#ffffff', rgb: '255, 255, 255', hsl: '0, 0%, 100%', cssVar: 'var(--color-white)', tailwind: 'white' },
  },
  secondary: {
    light: VIOLET[400],
    DEFAULT: VIOLET[500],
  ...
  warning: {
    ...
    DEFAULT: AMBER[500],
    dark: AMBER[600],
    contrast: { hex: '#000000', rgb: '0, 0, 0', hsl: '0, 0%, 0%', cssVar: 'var(--color-black)', tailwind: 'black' },
  },
  error: {
    light: ROSE[400],
    DEFAULT: ROSE[500],
...
export function getSemanticColor(
  ...
  const colors = theme === 'dark' ? SEMANTIC_COLORS_DARK : SEMANTIC_COLORS_LIGHT;
