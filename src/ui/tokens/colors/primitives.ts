 ...
 */
function createToken(hex: string, colorName: string, scale: ColorScale): ColorToken {
 ...
 */
export function getPrimitiveColor(name: PrimitiveColorName, scale: ColorScale): ColorToken {
 ...
 */
export function getPrimitiveColorPalette(name: PrimitiveColorName): ColorPalette {
