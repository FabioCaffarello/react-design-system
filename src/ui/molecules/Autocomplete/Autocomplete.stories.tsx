...
export const Default: Story = {
    ...
    return (
      <div className="space-y-4 w-full max-w-md">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          {selected && (
            <p><strong>Selected:</strong> {basicOptions.find(o => o.value === selected)?.label}</p>
          )}
  ...
  parameters: {
    docs: {
      description: {
        story: "Interactive autocomplete with real state. Type to search and select an option.",
      },
    },
  },
};
...
export const Loading: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Autocomplete with real loading state. Type to trigger a simulated API call with loading indicator.",
      },
    },
  },
};
...
export const EmptyState: Story = {
    ...
    return (
      <div className="space-y-4 w-full max-w-md">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          ...
          {!value && (
            <p>Type to search. Try "Apple" or "Banana"</p>
          )}
        </div>
      </div>
    );
  ...
  parameters: {
    docs: {
      description: {
        story: "Autocomplete with empty state. Type something that doesn't match to see the empty state message.",
      },
    },
  },
};
...
export const Controlled: Story = {
  render: () => {
    const [value, setValue] = React.useState('');
    const [selectedOption, setSelectedOption] = React.useState<typeof basicOptions[0] | null>(null);
    ...
    return (
      <div className="space-y-4 w-full max-w-md">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          ...
          {selectedOption && (
            <p><strong>Selected option:</strong> {selectedOption.label} (value: {selectedOption.value})</p>
          )}
          <button
            onClick={() => {
              setValue('');
  ...
  parameters: {
    docs: {
      description: {
        story: "Controlled autocomplete with external state management. Use the Clear button to reset.",
      },
    },
  },
};
...
export const LargeDataset: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4 w-full max-w-md">
        ...
        />
        <div className="text-sm text-gray-600 space-y-1">
          <p><strong>Total options:</strong> 100</p>
          <p><strong>Filtered results:</strong> {filteredCount}</p>
          {selected && (
            <p><strong>Selected:</strong> Option {selected}</p>
          )}
          <p className="text-xs text-gray-500 mt-2">
            Demonstrates performance with large datasets. Type to filter options.
          </p>
        </div>
      </div>
    );
  ...
  parameters: {
    docs: {
      description: {
        story: "Autocomplete with large dataset (100 options). Demonstrates performance and filtering with many items.",
      },
    },
  },
};
...
export const KeyboardNavigation: Story = {
    ...
    return (
      <div className="space-y-4 w-full max-w-md">
        ...
        <div className="text-sm text-gray-600 space-y-2 p-4 bg-gray-50 rounded">
          ...
          {selected && (
            <p className="mt-2"><strong>Selected:</strong> {basicOptions.find(o => o.value === selected)?.label}</p>
          )}
        </div>
      </div>
    );
  ...
  parameters: {
    docs: {
      description: {
        story: "Autocomplete demonstrating keyboard navigation. Try using only keyboard to search and select.",
      },
    },
  },
};
...
export const WithEvents: Story = {
    ...
    return (
      <div className="space-y-4 w-full max-w-md">
        <p className="text-sm text-gray-600">
          Type in the autocomplete and select an option. Check the Actions panel to see events being fired.
        </p>
        <Autocomplete
          options={basicOptions}
          value={value}
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates autocomplete events. Type and select an option, then check the Actions panel to see events being logged.',
      },
    },
  },
};
  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-md">
        ...
        />
        <p className="text-xs text-gray-500 mt-2">Focus the input to see the open state</p>
      </div>
    );
  },
  play: async ({ canvasElement }) => {
...
export const NoResults: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'No results state - shows when no options match the search query.',
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Disabled state - autocomplete is disabled and cannot be interacted with.',
      },
    },
  },
};
