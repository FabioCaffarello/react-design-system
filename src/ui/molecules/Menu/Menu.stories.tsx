...
import { Menu, MenuTrigger, MenuContent, MenuItem, MenuSeparator } from './index';
...
export const WithEvents: Story = {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Interact with the menu below. Check the Actions panel to see events being fired.
        </p>
        ...
        <p className="text-sm text-gray-500">Menu is {open ? 'open' : 'closed'}</p>
      </div>
    );
  },
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates all menu events. Interact with the menu and check the Actions panel to see events being logged.',
      },
    },
  },
};
