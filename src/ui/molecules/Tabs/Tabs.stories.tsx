...
export const Controlled: Story = {
    ...
    return (
      <div className="space-y-4">
        ...
        <Tabs value={activeTab} onValueChange={handleTabChange}>
          ...
          <Tabs.Content value="tab1">
            <Card className="p-4">
              <p>Controlled tab 1 content. Active tab: <strong>{activeTab}</strong></p>
            </Card>
          </Tabs.Content>
          <Tabs.Content value="tab2">
            <Card className="p-4">
              <p>Controlled tab 2 content. Active tab: <strong>{activeTab}</strong></p>
            </Card>
          </Tabs.Content>
          <Tabs.Content value="tab3">
            <Card className="p-4">
              <p>Controlled tab 3 content. Active tab: <strong>{activeTab}</strong></p>
            </Card>
          </Tabs.Content>
        </Tabs>
        <div className="text-sm text-gray-600">
          <p><strong>Tab History:</strong> {tabHistory.join(' → ')}</p>
        </div>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Example of controlled tabs where the active tab is managed externally. Tab changes are tracked in history.',
      },
    },
  },
};
...
export const WithRealContent: Story = {
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className={settings.notifications ? 'text-green-600' : 'text-gray-400'}>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Tabs with real content and data. Navigate between tabs to see different content sections.',
      },
    },
  },
};
...
export const DynamicTabs: Story = {
  render: () => {
    ...
    const addTab = () => {
      ...
      setTabs([...tabs, { id: newId, label: newTabLabel, content: `Content for ${newTabLabel}` }]);
      setActiveTab(newId);
      setNewTabLabel('');
    };
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="text-sm text-gray-600">
          ...
          <p><strong>Active tab:</strong> {tabs.find(t => t.id === activeTab)?.label}</p>
        </div>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Dynamic tabs that can be added and removed. Add new tabs and remove existing ones to see the tabs update dynamically.',
      },
    },
  },
};
...
export const KeyboardNavigation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates keyboard navigation. Use Tab to focus, then Arrow keys to navigate, Enter/Space to activate.',
      },
    },
  },
};
...
export const WithEvents: Story = {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Click tabs to switch. Check the Actions panel to see events being fired.
        </p>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates tabs events. Click tabs and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const ManualModeState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Manual mode state - tabs activate only when Enter or Space is pressed.',
      },
    },
  },
};
