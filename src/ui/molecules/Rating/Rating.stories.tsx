...
export const Default: Story = {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          <p><strong>Current rating:</strong> {value} / {args.max || 5}</p>
          {hoverValue !== null && (
            <p><strong>Hovering:</strong> {hoverValue} / {args.max || 5}</p>
          )}
        </div>
      </div>
    );
  ...
  parameters: {
    docs: {
      description: {
        story: "Interactive rating with real state. Click stars to rate, hover to see preview.",
      },
    },
  },
};
...
export const InContext: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Rating component in a real-world context. Rate different aspects and see the average calculated in real-time.",
      },
    },
  },
};
...
export const WithEvents: Story = {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Click stars to rate or hover over them. Check the Actions panel to see events being fired.
        </p>
        <Rating
          value={value}
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates rating events. Click or hover over stars and check the Actions panel to see events being logged.',
      },
    },
  },
};
