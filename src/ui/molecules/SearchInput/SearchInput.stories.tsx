...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Basic search input with real state. Type and see the value update, then press Enter or wait for debounce.",
      },
    },
  },
};
...
export const WithLoading: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Search with real loading state. Type and search to see the loading spinner for 2 seconds.",
      },
    },
  },
};
...
export const WithDebounce: Story = {
    ...
    return (
      <div className="w-64 space-y-4">
        ...
        <div className="text-xs text-gray-500">
          {value ? `Typing: "${value}" (wait 500ms after stopping)` : 'Start typing...'}
        </div>
        {searchTerm && (
              ...
              searchResults.length > 0 ? (
                <ul className="text-sm space-y-1">
                  {searchResults.map((result, i) => (
                    <li key={i} className="p-1 hover:bg-gray-50 rounded cursor-pointer">
                      {result}
                    </li>
                  ))}
                </ul>
  ...
  parameters: {
    docs: {
      description: {
        story: "Search with real debounce. Type and wait 500ms after stopping to see search results. Notice the debounce delay.",
      },
    },
  },
};
...
export const InForm: Story = {
          ...
          <div className="border-t pt-4">
            ...
            <ul className="text-sm space-y-1">
              {results.map((product, i) => (
                <li key={i} className="p-2 hover:bg-gray-50 rounded cursor-pointer">
                  {product}
                </li>
              ))}
            </ul>
  ...
  parameters: {
    docs: {
      description: {
        story: "Search input integrated in a form with real search results. Type to search products.",
      },
    },
  },
};
...
export const WithClear: Story = {
  render: () => {
    ...
    return (
      <div className="w-64 space-y-4">
        ...
        <div className="text-sm text-gray-600">
          {cleared && (
            <p className="text-green-600">✓ Search cleared!</p>
          )}
          <p><strong>Value:</strong> {value || '(empty)'}</p>
  ...
  parameters: {
    docs: {
      description: {
        story: "Search input with clear functionality. Use the X button to clear the search term.",
      },
    },
  },
};
...
export const WithEvents: Story = {
    ...
    return (
      <div className="w-64 space-y-4">
        <p className="text-sm text-gray-600">
          Type, search, or clear. Check the Actions panel to see events being fired.
        </p>
        <SearchInput
          value={value}
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates search input events. Type, search, or clear and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Disabled state - search input is disabled and cannot be interacted with.',
      },
    },
  },
};
