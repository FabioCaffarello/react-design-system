...
export const WithAction: Story = {
      ...
      return (
        <div className="space-y-4">
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-green-800">Epic created! Items: {items.join(", ")}</p>
            <button
              onClick={() => setItems([])}
  ...
  parameters: {
    docs: {
      description: {
        story: "Empty state with real action. Click the button to see it create an item.",
      },
    },
  },
};
...
export const WithIllustration: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Empty state with illustration and real action. Click to add stories and see them appear.",
      },
    },
  },
};
...
export const DifferentIllustrations: Story = {
  render: () => {
    ...
    const illustrations = {
      inbox: <Inbox className="mx-auto h-12 w-12 text-gray-400" aria-hidden="true" />,
      folder: <FolderOpen className="mx-auto h-12 w-12 text-gray-400" aria-hidden="true" />,
      file: <FileText className="mx-auto h-12 w-12 text-gray-400" aria-hidden="true" />,
    };
    ...
    const configs = {
      ...
      folder: {
        title: "No folders",
        message: "You don't have any folders yet. Create one to organize your files.",
  ...
  parameters: {
    docs: {
      description: {
        story: "Empty state with different illustrations. Switch between types to see different contexts.",
      },
    },
  },
};
...
export const WithEvents: Story = {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Click the action button. Check the Actions panel to see events being fired.
        </p>
        <EmptyState
          title="No items found"
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates empty state events. Click the action button and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const WithIllustrationState: Story = {
  args: {
    ...
    variant: "withIllustration",
    illustration: <FileText className="mx-auto h-12 w-12 text-gray-400" aria-hidden="true" />,
  },
  parameters: {
    docs: {
      description: {
        story: 'With illustration state - empty state includes an illustration icon.',
      },
    },
  },
};
