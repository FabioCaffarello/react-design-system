...
export const Default: StoryObj<typeof Pagination> = {
  render: () => {
    ...
    const currentItems = Array.from({ length: endIndex - startIndex }, (_, i) => ({
      id: startIndex + i + 1,
  ...
  parameters: {
    docs: {
      description: {
        story: "Pagination with real data simulation. Navigate through pages to see different data displayed.",
      },
    },
  },
};
...
export const WithoutPageInfo: StoryObj<typeof Pagination> = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Pagination without page info display. Useful for compact layouts.",
      },
    },
  },
};
...
export const WithManyPages: StoryObj<typeof Pagination> = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Pagination with many pages (50). Demonstrates ellipsis and navigation with large page counts.",
      },
    },
  },
};
...
export const InTable: StoryObj<typeof Pagination> = {
                ...
                <tr key={item.id} className="border-t border-gray-200 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 text-sm">
                    <span className={`px-2 py-1 rounded text-xs ${
                      ...
                      item.role === 'User' ? 'bg-green-100 text-green-800' :
  ...
  parameters: {
    docs: {
      description: {
        story: "Pagination integrated in a data table. Navigate through pages to see different rows displayed.",
      },
    },
  },
};
...
export const WithEvents: StoryObj<typeof Pagination> = {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Navigate through pages. Check the Actions panel to see events being fired.
        </p>
        <Pagination
          currentPage={page}
          totalPages={10}
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates pagination events. Navigate through pages and check the Actions panel to see events being logged.',
      },
    },
  },
};
