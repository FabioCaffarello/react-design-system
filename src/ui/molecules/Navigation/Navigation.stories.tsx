...
export const WithIcons: Story = {
  args: {
    items: [
      { href: '/home', label: 'Home', icon: <Home className="h-4 w-4" />, active: true },
  ...
  args: {
    items: [
      { 
        ...
        badge: <span className="ml-2 rounded-full bg-red-500 text-white text-xs px-2 py-0.5">3</span>
      },
      { 
        href: '/messages', 
        label: 'Messages',
        icon: <FileText className="h-4 w-4" />,
        badge: <span className="ml-2 rounded-full bg-blue-500 text-white text-xs px-2 py-0.5">12</span>
      },
    ],
  },
};
...
export const BareMode: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Use `bare` prop when Navigation is used inside Header.Navigation to avoid nested nav elements.',
      },
    },
  },
};
