...
describe('Navigation', () => {
  ...
  describe('Orientation', () => {
    it('should render horizontal navigation by default', () => {
      ...
      const { container } = render(<Navigation items={items} orientation="horizontal" />);
      const nav = container.querySelector('nav');
      expect(nav).toBeInTheDocument();
    ...
    it('should render vertical navigation', () => {
      ...
      const { container } = render(<Navigation items={items} orientation="vertical" />);
      const nav = container.querySelector('nav');
      expect(nav).toBeInTheDocument();
  ...
  describe('Variants', () => {
    it('should apply default variant', () => {
      ...
      const items: NavItem[] = [{ href: '/home', label: 'Home' }];
      const { container } = render(<Navigation items={items} variant="default" />);
      const nav = container.querySelector('nav');
      expect(nav).toBeInTheDocument();
    });
    ...
    it('should apply pills variant', () => {
      ...
      const items: NavItem[] = [{ href: '/home', label: 'Home' }];
      const { container } = render(<Navigation items={items} variant="pills" />);
      const nav = container.querySelector('nav');
      expect(nav).toBeInTheDocument();
    });
  ...
  describe('Icons', () => {
    it('should render items with icons', () => {
      ...
      const items: NavItem[] = [
        { href: '/home', label: 'Home', icon: <Home data-testid="home-icon" /> },
      ];
  ...
  describe('Disabled Items', () => {
    ...
    it('should not be clickable when disabled', () => {
      ...
      expect(hrefValue === null || hrefValue === '' || hrefValue === 'undefined').toBe(true);
    });
  });
  ...
  describe('Custom ClassName', () => {
    it('should apply custom className to nav element', () => {
      ...
      const items: NavItem[] = [{ href: '/home', label: 'Home' }];
      const { container } = render(<Navigation items={items} className="custom-nav" />);
      const nav = container.querySelector('nav');
  ...
  describe('Accessibility', () => {
    ...
    it('should allow custom aria-label', () => {
      ...
      const items: NavItem[] = [{ href: '/home', label: 'Home' }];
      const { container } = render(<Navigation items={items} aria-label="Custom navigation" />);
      const nav = container.querySelector('nav');
  ...
  describe('Badges', () => {
    it('should render items with badges', () => {
      ...
      const items: NavItem[] = [
        { href: '/notifications', label: 'Notifications', badge: <span data-testid="badge">3</span> },
      ];
