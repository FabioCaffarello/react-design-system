 ...
 * Organism Builder
 * 
 * Builder for creating organism components.
 */
 ...
 * Organism Builder
 * 
 * Builder for creating organism components that combine molecules and atoms.
 */
export class OrganismBuilder {
  /**
   * Build an organism component
   */
  static build(
...
// Import molecules and atoms as needed
 ...
 * 
 * ${config.description || 'Organism component that combines molecules and atoms'}
 */
...
const meta: Meta<typeof ${config.name}> = {
  title: 'UI/Organisms/${config.name}',
