...
describe("cva", () => {
  ...
  it("handles multiple variant dimensions", () => {
    ...
    expect(buttonVariants({ variant: "primary", size: "sm" })).toBe(
      "base bg-blue-500 text-sm",
    );
    expect(buttonVariants({ variant: "secondary", size: "md" })).toBe(
      "base bg-gray-500 text-base",
    );
  });
  ...
  it("handles compound variants", () => {
    ...
    expect(badgeVariants({ variant: "success", style: "solid" })).toBe(
      "base bg-green-500 text-white",
    );
    expect(badgeVariants({ variant: "error", style: "outline" })).toBe(
