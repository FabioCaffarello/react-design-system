 ...
 */
export const SideNavbarThemeContext = createContext<SideNavbarThemeContextValue | null>(null);
...
export function useSideNavbarThemeRequired(): SideNavbarThemeContextValue {
  ...
  if (!context) {
    throw new Error('useSideNavbarThemeRequired must be used within SideNavbarThemeProvider');
  }
  return context;
}
