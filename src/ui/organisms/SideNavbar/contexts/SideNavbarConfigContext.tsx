 ...
 */
export const SideNavbarConfigContext = createContext<SideNavbarConfigContextValue | null>(null);
...
export function useSideNavbarConfigRequired(): SideNavbarConfigContextValue {
  ...
  if (!context) {
    throw new Error('useSideNavbarConfigRequired must be used within SideNavbarConfigProvider');
  }
  return context;
}
