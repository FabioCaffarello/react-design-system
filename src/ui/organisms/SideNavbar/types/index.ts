 ...
 */
export type SideNavbarVariant = 'default' | 'compact' | 'elevated' | 'minimal' | 'bordered';
...
export interface SideNavbarRootProps extends Omit<HTMLAttributes<HTMLElement>, 'children'> {
  /** Children components */
  children: ReactNode;
}

export interface SideNavbarToggleProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'children'> {
  /** Position of the toggle button */
 ...
 */
export interface NavbarItemProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'children'> {
  /** Unique identifier */
  id?: string;
  /** Icon to display */
  icon: ReactNode;
...
export interface NavbarToggleProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'children'> {
  /** Custom icon or render function */
  icon?: ReactNode | ((collapsed: boolean) => ReactNode);
  /** Button size */
  size?: 'xs' | 'sm' | 'md';
