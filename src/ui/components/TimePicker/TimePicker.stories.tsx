...
export const WithEvents: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates time picker events. Select a time and check the Actions panel to see events being logged.",
      },
    },
  },
};
...
export const Format12hState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "12h format state - time is displayed in 12-hour format with AM/PM.",
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Disabled state - time picker is disabled and cannot be interacted with.",
      },
    },
  },
};
