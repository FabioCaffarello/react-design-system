...
export const Default: StoryObj<typeof Breadcrumb> = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Interactive breadcrumb with navigation. Click links to see the path change.",
      },
    },
  },
};
...
export const TwoLevels: StoryObj<typeof Breadcrumb> = {
  args: {
    items: [{ label: "Dashboard", href: "/" }, { label: "Epics" }],
  },
};
...
export const ThreeLevels: StoryObj<typeof Breadcrumb> = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Breadcrumb with multiple levels and navigation. Click links to navigate between pages.",
      },
    },
  },
};
...
export const WithEvents: StoryObj<typeof Breadcrumb> = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates breadcrumb events. Click breadcrumb items and check the Actions panel to see events being logged.",
      },
    },
  },
};
...
export const SingleItemState: StoryObj<typeof Breadcrumb> = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Single item state - breadcrumb with only one item (current page).",
      },
    },
  },
};
