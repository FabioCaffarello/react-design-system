...
const basicItems = [
  {
    ...
    title: "What is this?",
    content:
      "This is a frequently asked question with a detailed answer that explains the concept clearly.",
  },
  {
    id: "2",
    title: "How does it work?",
    content:
      "The system works by processing input data through a series of algorithms and returning the results.",
  },
  {
    id: "3",
    title: "Is it free?",
    content:
      "Yes, the basic version is free. Premium features are available with a subscription.",
  },
];
    ...
    items: [
      {
        ...
        content: (
          <div className="space-y-4">
            <p>
              This is a longer content example to demonstrate how the accordion
              handles substantial amounts of text and content. The accordion
              should expand smoothly and provide a good user experience even
              with lengthy content.
            </p>
            <p>
              You can include multiple paragraphs, lists, images, or any other
              React components within the accordion content area. The component
              will handle the animation and layout automatically.
            </p>
...
export const WithEvents: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates accordion events. Click accordion items and check the Actions panel to see events being logged.",
      },
    },
  },
};
