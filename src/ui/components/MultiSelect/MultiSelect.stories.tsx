...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Interactive multi-select with real state. Select items and see them displayed below.",
      },
    },
  },
};
...
export const WithMaxSelected: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Multi-select with maximum selection limit. Try selecting more than 3 items to see the limit in action.",
      },
    },
  },
};
...
export const WithSelectAll: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Multi-select with Select All functionality. Use the 'Select All' option to select/deselect all items at once.",
      },
    },
  },
};
...
export const Controlled: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Controlled multi-select with external state management. Use the Clear button to reset selection.",
      },
    },
  },
};
...
export const WithSearch: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Multi-select with search functionality. Type in the input field to filter the available options.",
      },
    },
  },
};
...
export const ManyOptions: Story = {
        ...
        <div className="text-sm text-gray-600">
          ...
          {selected.length > 0 && (
            <p className="mt-1">
              {selected
                .slice(0, 5)
                .map((v) => manyOptions.find((o) => o.value === v)?.label)
                .join(", ")}
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Multi-select with many options (50). Demonstrates performance and search functionality with large lists.",
      },
    },
  },
};
...
export const KeyboardNavigation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Multi-select demonstrating keyboard navigation. Try using keyboard only to select items.",
      },
    },
  },
};
...
export const RealTimeSearch: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Multi-select with real-time search filtering. Type in the input to see options filter in real-time.",
      },
    },
  },
};
...
export const EdgeCases: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Edge cases: empty options, single option, disabled state, and loading state.",
      },
    },
  },
};
...
export const SelectAllAndDeselectAll: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates Select All functionality both from the dropdown and external buttons.",
      },
    },
  },
};
...
export const WithEvents: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates multi-select events. Select items and check the Actions panel to see events being logged.",
      },
    },
  },
};
...
export const WithSelectionState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "With selection state - items are selected and displayed as tags.",
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Disabled state - multi-select is disabled and cannot be interacted with.",
      },
    },
  },
};
