...
export const WithFooter: StoryObj<typeof Modal> = {
  render: () => (
    ...
    >
      <Text as="p">
        This action cannot be undone. Are you sure you want to delete this epic?
      </Text>
    </ModalWrapper>
  ),
};
  ...
  render: () => (
    <ModalWrapper title="Large Modal" variant="large">
      ...
      <div className="space-y-2">
        <Text as="p">
          You can add forms, tables, or any other content here.
        </Text>
      </div>
    </ModalWrapper>
  ),
...
export const WithoutCloseButton: StoryObj<typeof Modal> = {
  render: () => (
    <ModalWrapper title="No Close Button" showCloseButton={false}>
      <Text as="p">
        This modal doesn't have a close button. Users must use the footer
        actions.
      </Text>
    </ModalWrapper>
  ),
...
export const WithEvents: StoryObj<typeof Modal> = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates modal events. Open and close the modal, then check the Actions panel to see events being logged.",
      },
    },
  },
};
...
export const WithoutCloseButtonState: StoryObj<typeof Modal> = {
  render: () => {
    ...
    return (
      ...
      >
        <Text as="p">
          This modal does not have a close button. Use footer actions or click
          outside to close.
        </Text>
      </Modal>
    );
