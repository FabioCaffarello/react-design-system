...
export const WithEvents: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates color picker events. Select a color and check the Actions panel to see events being logged.",
      },
    },
  },
};
...
export const WithInputState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "With input state - color picker includes an input field for direct color entry.",
      },
    },
  },
};
...
export const DisabledState: Story = {
  render: () => <ColorPicker label="Color" value="#3b82f6" disabled />,
  parameters: {
    docs: {
      description: {
        story:
          "Disabled state - color picker is disabled and cannot be interacted with.",
      },
    },
  },
};
...
export const WithPresetsState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "With presets state - color picker includes preset color options.",
      },
    },
  },
};
