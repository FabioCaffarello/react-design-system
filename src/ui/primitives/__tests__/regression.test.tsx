...
describe("Atoms Regression Tests", () => {
  ...
  describe("Accessibility - ARIA Attributes", () => {
    ...
    it("Radio has correct aria attributes", () => {
      render(
        <Radio label="Test" error helperText="Error message" id="test-radio" />,
      );
    ...
    it("Input has correct aria attributes", () => {
      render(
        <Input label="Email" error helperText="Invalid email" id="email" />,
      );
  ...
  describe("Error States", () => {
    it("Form inputs show error state correctly", () => {
      ...
      expect(
        checkboxContainer.querySelector('[aria-invalid="true"]'),
      ).toBeInTheDocument();
      expect(
        radioContainer.querySelector('[aria-invalid="true"]'),
      ).toBeInTheDocument();
      expect(
        inputContainer.querySelector('[aria-invalid="true"]'),
      ).toBeInTheDocument();
    });
  ...
  describe("Disabled States", () => {
    it("All form inputs respect disabled prop", () => {
      ...
      const { container: selectContainer } = render(
        <Select label="Select" options={[]} disabled />,
      );
      const { container: textareaContainer } = render(<Textarea disabled />);
      const { container: switchContainer } = render(
      ...
      expect(
        radioContainer.querySelector('input[type="radio"]'),
      ).toBeDisabled();
      ...
      expect(
        switchContainer.querySelector('input[type="checkbox"]'),
      ).toBeDisabled();
