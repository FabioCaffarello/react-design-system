...
export const InfoVariant: Story = {
  args: {
    variant: "info",
    children:
      "This is an informational message. Use this variant for general information.",
  },
};
...
export const Warning: Story = {
  args: {
    variant: "warning",
    children:
      "This is a warning message. Use this variant to alert users about potential issues.",
  },
};
...
export const Error: Story = {
  args: {
    variant: "error",
    children:
      "This is an error message. Use this variant to display critical errors or validation failures.",
  },
};
...
export const AllVariants: Story = {
  render: () => (
    <div className="space-y-4 max-w-md">
      <Info variant="info">Your changes have been saved successfully.</Info>
      <Info variant="warning">
        Please review your changes before submitting.
      </Info>
      <Info variant="error">There was an error processing your request.</Info>
    </div>
  ),
};
...
export const InContext: Story = {
  render: () => (
    <div className="space-y-4 max-w-md">
      ...
      <Info variant="error">
        <strong>Error:</strong> Unable to connect to the server. Please check
...
export const LongContent: Story = {
  args: {
    variant: "info",
    children:
      "This is a longer informational message that demonstrates how the Info component handles extended content. It should wrap properly and maintain good readability.",
  },
};
