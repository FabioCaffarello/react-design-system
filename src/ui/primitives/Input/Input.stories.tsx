...
export const WithEvents: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates all input events. Interact with the input and check the Actions panel to see events being logged.",
      },
    },
  },
};
...
export const DefaultState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Default state of the input - normal appearance, ready for interaction.",
      },
    },
  },
};
...
export const FocusState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Focus state - activated when input receives focus. Shows focus outline for accessibility.",
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Disabled state - input is not interactive, shows reduced opacity and is not editable.",
      },
    },
  },
};
...
export const ReadonlyState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Read-only state - input displays value but cannot be edited. No focus outline.",
      },
    },
  },
};
