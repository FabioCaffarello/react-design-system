...
export const SemanticElements: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates the polymorphic `as` prop to render as different HTML elements.",
      },
    },
  },
};
...
export const Colors: Story = {
  render: () => (
    <div className="space-y-2">
      <Text colorRole="neutral" colorShade="dark">
        Neutral Dark (default)
      </Text>
      <Text colorRole="primary" colorShade="DEFAULT">
        Primary
      </Text>
      <Text colorRole="secondary" colorShade="DEFAULT">
        Secondary
      </Text>
      <Text colorRole="success" colorShade="DEFAULT">
        Success
      </Text>
      <Text colorRole="warning" colorShade="DEFAULT">
        Warning
      </Text>
      <Text colorRole="error" colorShade="DEFAULT">
        Error
      </Text>
      <Text colorRole="info" colorShade="DEFAULT">
        Info
      </Text>
      <Text colorRole="neutral" colorShade="light">
        Neutral Light
      </Text>
      <Text colorRole="primary" colorShade="dark">
        Primary Dark
      </Text>
      <Text colorRole="primary" colorShade="contrast">
        Primary Contrast
      </Text>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates colorRole and colorShade props for semantic colors.",
      },
    },
  },
};
...
export const Combined: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Examples combining variant, colorRole, colorShade, and other props.",
      },
    },
  },
};
  ...
  render: () => (
    <div className="space-y-4 max-w-md">
      ...
      <Text as="p" variant="body">
        This is the main content of the article. It demonstrates how the Text
        component can be used in a real-world context with proper semantic HTML
        elements.
      </Text>
...
export const Polymorphic: Story = {
    ...
    <div className="space-y-4">
      <div>
        <Text as="h1" variant="heading">
          Same variant, different element
        </Text>
      ...
      <div>
        <Text as="p" variant="body">
          Paragraph with body variant
        </Text>
        <Text as="span" variant="body">
          Span with body variant
        </Text>
        <Text as="div" variant="body">
          Div with body variant
        </Text>
      </div>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates how the `as` prop allows rendering the same variant as different HTML elements.",
      },
    },
  },
};
