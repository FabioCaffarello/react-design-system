...
export const WithEvents: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates all switch events. Interact with the switch and check the Actions panel to see events being logged.",
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Disabled state - switch is not interactive, shows reduced opacity.",
      },
    },
  },
};
...
export const ErrorState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Error state - shows error indicator. Used for validation feedback.",
      },
    },
  },
};
