...
export const Range: Story = {
  render: (args) => {
    const [value, setValue] = useState<[number, number]>(
      (args.defaultValue as [number, number]) || [20, 80],
    );
    return (
      <div className="w-64">
        <Slider
...
export const KeyboardNavigation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates keyboard navigation support. Use Tab to focus and Arrow keys to change value.",
      },
    },
  },
};
...
export const RangeMode: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates range mode with dual thumbs for selecting a range of values.",
      },
    },
  },
};
...
export const WithEvents: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates slider events. Interact with the slider and check the Actions panel to see events being logged.",
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Disabled state - slider is not interactive, shows reduced opacity.",
      },
    },
  },
};
...
export const SingleMode: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Single mode - slider with one thumb for selecting a single value.",
      },
    },
  },
};
...
export const RangeModeState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Range mode - slider with two thumbs for selecting a range of values.",
      },
    },
  },
};
