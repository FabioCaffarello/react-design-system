  ...
  render: () => (
    <div className="space-y-4">
      <p className="text-sm text-gray-600">
        Try navigating with Tab key. Tooltips appear immediately on focus (no delay):
      </p>
      ...
      <p className="text-xs text-gray-500">
        Tooltips support keyboard navigation: Tab to focus, tooltip appears immediately. Press Escape to close.
      </p>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: "Demonstrates keyboard navigation. Tooltips appear immediately on focus (no delay) for better accessibility.",
      },
    },
  },
};
...
export const WithDifferentDelays: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-600">
        Note: Delay only applies to hover. On focus, tooltip appears immediately.
      </p>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: "Demonstrates different delay options. Delay only applies to hover, not focus.",
      },
    },
  },
};
...
export const WithEvents: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Hover or focus the button below. Check the Actions panel to see events being fired.
        </p>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates tooltip events. Hover or focus the button and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const ClosedState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Closed state - tooltip is hidden, ready to be shown on hover or focus.',
      },
    },
  },
};
