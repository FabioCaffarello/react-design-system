...
describe('NavLink', () => {
  ...
  describe('Variants', () => {
    ...
    it('applies underline variant', () => {
      const { container } = render(
        <NavLink href="/home" variant="underline">Home</NavLink>
      );
      const link = container.querySelector('a');
    ...
    it('applies background variant', () => {
      const { container } = render(
        <NavLink href="/home" variant="background">Home</NavLink>
      );
      const link = container.querySelector('a');
  ...
  describe('Sizes', () => {
    it('applies sm size', () => {
      const { container } = render(
        <NavLink href="/home" size="sm">Home</NavLink>
      );
      const link = container.querySelector('a');
      expect(link).toBeInTheDocument();
    });
    ...
    it('applies lg size', () => {
      const { container } = render(
        <NavLink href="/home" size="lg">Home</NavLink>
      );
      const link = container.querySelector('a');
      expect(link).toBeInTheDocument();
    });
  ...
  describe('Active State', () => {
    ...
    it('applies active styles for default variant', () => {
      const { container } = render(
        <NavLink href="/home" active variant="default">Home</NavLink>
      );
      const link = container.querySelector('a');
      expect(link).toHaveAttribute('data-active', 'true');
    });
    ...
    it('applies active styles for underline variant', () => {
      const { container } = render(
        <NavLink href="/home" active variant="underline">Home</NavLink>
      );
      const link = container.querySelector('a');
      expect(link).toHaveAttribute('data-active', 'true');
    });
    ...
    it('applies active styles for background variant', () => {
      const { container } = render(
        <NavLink href="/home" active variant="background">Home</NavLink>
      );
      const link = container.querySelector('a');
      expect(link).toHaveAttribute('data-active', 'true');
    });
  ...
  describe('Disabled State', () => {
    it('applies disabled classes when disabled', () => {
      const { container } = render(
        <NavLink href="/home" disabled>Home</NavLink>
      );
      const link = container.querySelector('a');
    ...
    it('removes href when disabled', () => {
      const { container } = render(<NavLink href="/home" disabled>Home</NavLink>);
      const link = container.querySelector('a');
