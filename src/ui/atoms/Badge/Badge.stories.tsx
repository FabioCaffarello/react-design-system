...
export const Accessibility: Story = {
    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Badge variant="error" aria-label="Status: Critical">Critical</Badge>
          <Badge variant="warning" aria-label="Status: Pending">Pending</Badge>
          <Badge variant="info" aria-label="Status: New">New</Badge>
        </div>
      </div>
      <div className="space-y-2">
        <p className="text-sm text-gray-600">Badges with non-string children and explicit aria-label:</p>
        <div className="flex flex-wrap gap-2">
      ...
      <div className="space-y-2">
        <p className="text-sm text-gray-600">Badges with role="status" for screen readers:</p>
        <div className="flex flex-wrap gap-2">
  ...
  parameters: {
    docs: {
      description: {
        story: 'Examples demonstrating accessibility features: ARIA labels for non-string children, role="status" for screen readers, and proper labeling.',
      },
    },
  },
};
...
export const WithNonStringChildren: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <p className="text-xs text-gray-500">
        When children is not a string, provide an explicit aria-label for accessibility.
      </p>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates how to use badges with non-string children and the importance of providing aria-label for accessibility.',
      },
    },
  },
};
