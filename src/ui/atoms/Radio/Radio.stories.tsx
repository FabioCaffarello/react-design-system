...
export const Default: Story = {
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-xs text-gray-500">
          Click on any option to select it. Only one option can be selected at a time.
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Interactive radio group with real state. Click to select and see the state change. Only one option can be selected at a time.',
      },
    },
  },
};
...
export const Checked: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-xs text-gray-500">
          Note: Radio buttons cannot be unchecked by clicking them again. You must select another option in the group.
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Radio button starting in checked state. Note: Radio buttons cannot be unchecked by clicking them again - you must select another option.',
      },
    },
  },
};
...
export const WithError: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        {selected && !submitted && (
          <p className="text-sm text-green-600">✓ Option selected: {selected}</p>
        )}
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Radio group with validation error. Try submitting without selecting an option to see the error state.',
      },
    },
  },
};
...
export const Disabled: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          The disabled option cannot be selected. Try clicking it - nothing happens. You can only select enabled options.
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Radio group with a disabled option. Disabled radios cannot be interacted with and cannot be selected.',
      },
    },
  },
};
...
export const RadioGroup: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Radio group with real state. Only one option can be selected at a time.',
      },
    },
  },
};
...
export const Controlled: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates controlled radio group with state management. Use buttons to control state externally.',
      },
    },
  },
};
...
export const Uncontrolled: Story = {
  render: () => {
    ...
    const [lastChange, setLastChange] = useState<string>('Initial: Option 1 (defaultChecked)');
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          <p><strong>Current selection:</strong> {selectedValue}</p>
          <p><strong>Last change:</strong> {lastChange}</p>
        </div>
        <p className="text-xs text-gray-500">
          This is an uncontrolled component using <code>defaultChecked</code>. The component manages its own state internally via the DOM. We track changes here only for demonstration purposes.
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates uncontrolled radio group using defaultChecked. The component manages its own state internally via the DOM, not React state.',
      },
    },
  },
};
...
export const FunctionalGroup: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600">Selected: <strong>{selected}</strong></p>
        <p className="text-xs text-gray-500">
          This example uses <code>fieldset</code> and <code>legend</code> for better accessibility and semantic HTML structure.
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Functional radio group with proper fieldset/legend for accessibility. This is the recommended pattern for form groups.',
      },
    },
  },
};
...
export const KeyboardNavigation: Story = {
      ...
      <div className="space-y-4">
        ...
        <div className="text-xs text-gray-500 space-y-1">
          ...
          <ul className="list-disc list-inside ml-2 space-y-1">
            <li><strong>Tab</strong>: Move focus to the radio group</li>
            <li><strong>Arrow Up/Down</strong>: Navigate between options</li>
            <li><strong>Arrow Left/Right</strong>: Navigate between options</li>
            <li><strong>Space</strong>: Select the focused option</li>
          </ul>
          <p className="mt-2">Disabled options are skipped during keyboard navigation.</p>
        </div>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates keyboard navigation support. Use Tab to focus and Arrow keys to change selection. The disabled option is skipped.',
      },
    },
  },
};
...
export const AllStates: Story = {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500">
            Click "Trigger Error" to show validation error on Option 5. Select Option 5 to clear the error.
          </p>
        </div>
      </div>
    );
  ...
  parameters: {
    docs: {
      description: {
        story: 'All visual states of the radio component. Some are interactive, others are disabled. Use the button to trigger an error state on Option 5, then select it to clear the error.',
      },
    },
  },
};
...
export const WithEvents: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Interact with the radio buttons below. Check the Actions panel to see events being fired.
        </p>
        <div className="space-y-2">
          <Radio
            name="events-group"
        ...
        <p className="text-sm text-gray-500">Selected: {selected || '(none)'}</p>
      </div>
    );
  },
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates all radio events. Interact with the radio buttons and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const UnselectedState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Unselected state - default state of the radio, ready for interaction.',
      },
    },
  },
};
...
export const DisabledStateStory: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Disabled state - radio is not interactive, shows reduced opacity.',
      },
    },
  },
};
