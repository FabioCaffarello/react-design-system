...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive textarea with real state. Type to see the character count and value update.',
      },
    },
  },
};
...
export const WithError: Story = {
      ...
      <div className="space-y-4">
        ...
        {submitted && value.length < minLength && (
          <p className="text-sm text-red-600">
            ⚠ Description must be at least {minLength} characters ({value.length}/{minLength})
          </p>
        )}
        <button
        ...
        {value.length >= minLength && !submitted && (
          <p className="text-sm text-green-600">✓ Description is valid ({value.length} characters)</p>
        )}
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Textarea with validation error. Try submitting with less than 10 characters to see the error state.',
      },
    },
  },
};
  ...
  render: () => (
    <div className="space-y-4">
      <div>
        ...
        <Textarea placeholder="Can resize vertically..." rows={4} resize="vertical" />
      </div>
      <div>
        <label className="block text-sm font-medium mb-1">Horizontal resize</label>
        <Textarea placeholder="Can resize horizontally..." rows={4} resize="horizontal" />
      </div>
      <div>
        <label className="block text-sm font-medium mb-1">Both directions</label>
        <Textarea placeholder="Can resize both ways..." rows={4} resize="both" />
      </div>
      <div>
...
export const Sizes: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <div>
        <label className="block text-sm font-medium mb-1">Medium (4 rows)</label>
...
export const AllStates: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1">Disabled with value</label>
  ...
  parameters: {
    docs: {
      description: {
        story: 'All visual states of the textarea component. Some are interactive, others are disabled.',
      },
    },
  },
};
...
export const WithCols: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <label className="block text-sm font-medium mb-1">Narrow (cols: 20)</label>
        <Textarea placeholder="Narrow textarea..." rows={4} cols={20} />
      </div>
      <div>
        <label className="block text-sm font-medium mb-1">Medium (cols: 40)</label>
        <Textarea placeholder="Medium textarea..." rows={4} cols={40} />
      </div>
      <div>
        <label className="block text-sm font-medium mb-1">Wide (cols: 60)</label>
...
export const WithEvents: Story = {
  render: () => {
    ...
    const handleFocus = fn((e: React.FocusEvent<HTMLTextAreaElement>) => {
      console.log('Textarea focused');
    });
    
    const handleBlur = fn((e: React.FocusEvent<HTMLTextAreaElement>) => {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Interact with the textarea below. Check the Actions panel to see events being fired.
        </p>
        <Textarea
          placeholder="Type something..."
          rows={4}
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates all textarea events. Interact with the textarea and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Disabled state - textarea is not interactive, shows reduced opacity.',
      },
    },
  },
};
