...
export const Default: Story = {
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Selected: <strong>{value ? options.find(o => o.value === value)?.label : '(none)'}</strong>
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Interactive select with real state. Select an option and see the value change.',
      },
    },
  },
};
...
export const WithError: Story = {
    ...
    return (
      <div className="space-y-4">
        <Select
          ...
          helperText={submitted && !value ? 'Please select an option' : undefined}
        />
        <button
        ...
        {value && !submitted && (
          <p className="text-sm text-green-600">✓ Option selected: {options.find(o => o.value === value)?.label}</p>
        )}
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Select with validation error. Try submitting without selecting an option to see the error state.',
      },
    },
  },
};
...
export const WithSuccess: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Select with success state. Shows success feedback when a valid option is selected.',
      },
    },
  },
};
...
export const Sizes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Select with different sizes. All are interactive and track their own state.',
      },
    },
  },
};
...
export const WithOptionGroups: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Select with option groups. Options are organized into categories.',
      },
    },
  },
};
...
export const WithManyOptions: Story = {
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-xs text-gray-500">
          This select has 20 options. Use keyboard navigation (Arrow keys) to quickly find options.
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Select with many options (20). Demonstrates performance and keyboard navigation with large lists.',
      },
    },
  },
};
...
export const Disabled: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      />
      <p className="text-sm text-gray-600">
        Disabled selects cannot be interacted with. Try clicking or using keyboard - nothing happens.
      </p>
    </div>
  ),
  parameters: {
...
export const AllStates: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'All visual states of the select component. Some are interactive, others are disabled.',
      },
    },
  },
};
...
export const KeyboardNavigation: Story = {
  render: () => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
      setValue(e.target.value);
      setLastAction(`Selected: ${options.find(o => o.value === e.target.value)?.label}`);
      ...
      <div className="space-y-4">
        ...
        <div className="text-xs text-gray-500 space-y-1">
          ...
          <ul className="list-disc list-inside ml-2 space-y-1">
            <li><strong>Tab</strong>: Focus the select</li>
            <li><strong>Arrow Up/Down</strong>: Navigate between options</li>
            <li><strong>Enter</strong>: Select the highlighted option</li>
            <li><strong>Escape</strong>: Close the dropdown (if open)</li>
            <li><strong>Type</strong>: Jump to option starting with that letter</li>
          </ul>
        </div>
      </div>
    );
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates keyboard navigation support. Use Tab to focus and Arrow keys to navigate. Select an option to see feedback.',
      },
    },
  },
};
...
export const WithEvents: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Interact with the select below. Check the Actions panel to see events being fired.
        </p>
        <Select
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates all select events. Interact with the select and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const ClosedState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Closed state - dropdown is closed, shows selected value or placeholder.',
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Disabled state - select is not interactive, shows reduced opacity.',
      },
    },
  },
};
