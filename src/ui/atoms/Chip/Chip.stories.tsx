...
export const Removable: Story = {
  render: () => {
    const [chips, setChips] = useState(['Removable Tag 1', 'Removable Tag 2', 'Removable Tag 3']);
    ...
    return (
      <div className="space-y-4">
        ...
        {chips.length === 0 && (
          <p className="text-sm text-gray-500">All chips removed. Refresh to see them again.</p>
        )}
        <p className="text-sm text-gray-600">
  ...
  parameters: {
    docs: {
      description: {
        story: 'Chips with remove functionality. Click the X button to remove chips and see them disappear.',
      },
    },
  },
};
...
export const Selected: Story = {
  render: () => {
    const [selectedChips, setSelectedChips] = useState<Set<string>>(new Set(['Tag 1']));
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Selected: <strong>{Array.from(selectedChips).join(', ') || 'None'}</strong>
        </p>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Chips with selectable state. Click chips to toggle their selected state.',
      },
    },
  },
};
...
export const Disabled: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-600">
        Disabled chips cannot be interacted with. Try clicking them - nothing happens.
      </p>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Disabled chips in various states. They cannot be clicked, selected, or removed.',
      },
    },
  },
};
...
export const Clickable: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-xs text-gray-500">
          Click chips to see them activate. Use Tab to focus, then Enter or Space to activate.
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Clickable chips with real click handling. Click chips to see feedback and click count.',
      },
    },
  },
};
...
export const ClickableAndRemovable: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Chips can be both clicked and removed. Click to activate, X button to remove.
        </p>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Chips that are both clickable and removable. Click to activate, use X button to remove.',
      },
    },
  },
};
...
export const Accessibility: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <p className="text-sm text-gray-600">Selected state with aria-selected:</p>
        <div className="flex gap-2">
      ...
      <div className="space-y-2">
        <p className="text-sm text-gray-600">Keyboard navigation: Use Tab to focus, Enter or Space to activate:</p>
        <div className="flex gap-2">
      ...
      <div className="space-y-2">
        <p className="text-sm text-gray-600">Removable chips with descriptive aria-label:</p>
        <div className="flex gap-2">
          <Chip
            onRemove={() => {}}
            aria-label="Applied filter: Technology"
          >
            Technology
          </Chip>
          <Chip
            onRemove={() => {}}
            aria-label="Applied filter: Design"
          >
            Design
          </Chip>
        </div>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Examples demonstrating accessibility features: ARIA labels, keyboard navigation (Tab, Enter, Space), and proper role attributes.',
      },
    },
  },
};
...
export const KeyboardNavigation: Story = {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-2">
          <Chip onClick={() => handleActivate('First Chip')}>First Chip (Tab here)</Chip>
        ...
        <div className="text-xs text-gray-500 space-y-1">
          ...
          <ul className="list-disc list-inside ml-2 space-y-1">
            <li><strong>Tab</strong>: Navigate to next chip</li>
            <li><strong>Shift + Tab</strong>: Navigate to previous chip</li>
            <li><strong>Enter</strong>: Activate focused chip</li>
            <li><strong>Space</strong>: Activate focused chip</li>
          </ul>
        </div>
      </div>
    );
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates keyboard navigation support. Use Tab to navigate between chips and Enter/Space to activate. See feedback when chips are activated.',
      },
    },
  },
};
...
export const WithEvents: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Interact with the chips below. Check the Actions panel to see events being fired.
        </p>
        <div className="flex flex-wrap gap-2">
          {chips.map((chip) => (
            <Chip
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates all chip events. Interact with the chips and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Disabled state - chip is not interactive, shows reduced opacity.',
      },
    },
  },
};
