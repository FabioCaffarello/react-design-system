...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive checkbox with real state. Click to toggle and see the state change.',
      },
    },
  },
};
...
export const WithError: Story = {
    ...
    return (
      <div className="space-y-4">
        <Checkbox
          ...
          helperText={submitted && !checked ? 'You must accept the terms to continue' : undefined}
        />
        <button
  ...
  parameters: {
    docs: {
      description: {
        story: 'Checkbox with validation error. Try submitting without checking to see the error state.',
      },
    },
  },
};
...
export const Disabled: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      />
      <p className="text-sm text-gray-600">
        Disabled checkboxes cannot be interacted with. Try clicking them - nothing happens.
      </p>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Disabled checkboxes in both checked and unchecked states. They cannot be interacted with.',
      },
    },
  },
};
...
export const WithoutLabel: Story = {
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-sm text-gray-600">Checkbox without visible label (uses aria-label)</span>
        </div>
        <p className="text-sm text-gray-600">
          Status: <strong>{checked ? 'Checked' : 'Unchecked'}</strong>
        </p>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Checkbox without visible label. Uses aria-label for accessibility.',
      },
    },
  },
};
...
export const Indeterminate: Story = {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          <p><strong>Select All State:</strong> {allChecked ? 'All checked' : indeterminate ? 'Indeterminate (some checked)' : 'All unchecked'}</p>
          <p><strong>Selected Items:</strong> {Object.entries(checkedItems).filter(([_, checked]) => checked).map(([key]) => key).join(', ') || 'None'}</p>
        </div>
      </div>
    );
  },
  parameters: {
    docs: {
      description: {
        story: 'Indeterminate state in a "select all" scenario. The "Select all" checkbox shows indeterminate when some (but not all) items are selected.',
      },
    },
  },
};
...
export const Controlled: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        />
        <div className="text-sm text-gray-600 space-y-1">
          <p><strong>Checked:</strong> {checked ? 'Yes' : 'No'}</p>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Controlled checkbox with external state management. Use buttons to control state externally.',
      },
    },
  },
};
...
export const AllStates: Story = {
    ...
    return (
      <div className="space-y-4">
        ...
        <Checkbox 
          ...
          checked={false}
          onChange={() => setStates({ ...states, indeterminate: !states.indeterminate })}
        />
  ...
  parameters: {
    docs: {
      description: {
        story: 'All visual states of the checkbox component. Some are interactive, others are disabled.',
      },
    },
  },
};
  ...
  render: () => (
    <div className="space-y-4">
      ...
      <p className="text-xs text-gray-500">
        All checkboxes support keyboard navigation: Tab to focus, Space to toggle.
      </p>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates keyboard navigation support. Use Tab to navigate and Space to toggle.',
      },
    },
  },
};
...
export const IndeterminateState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates indeterminate state in a "select all" scenario. Select some items to see the indeterminate state appear.',
      },
    },
  },
};
...
export const WithEvents: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Interact with the checkbox below. Check the Actions panel to see events being fired.
        </p>
        <Checkbox
          ...
          onBlur={handleBlur}
        />
        <p className="text-sm text-gray-500">Current state: {checked ? 'Checked' : 'Unchecked'}</p>
      </div>
    );
  },
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates all checkbox events. Interact with the checkbox and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const UncheckedState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Unchecked state - default state of the checkbox, ready for interaction.',
      },
    },
  },
};
...
export const IndeterminateStateStory: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Indeterminate state - shows horizontal line, used when some but not all items are selected.',
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Disabled state - checkbox is not interactive, shows reduced opacity.',
      },
    },
  },
};
