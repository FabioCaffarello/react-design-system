...
export const AllVariants: StoryObj<typeof Label> = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Demonstrates all label variants: default, required (with asterisk), and optional (with '(optional)' text).",
      },
    },
  },
};
...
export const WithDifferentInputs: StoryObj<typeof Label> = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Demonstrates Label component with different types of form inputs.",
      },
    },
  },
};
...
export const WithEvents: StoryObj<typeof Label> = {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Click the label below. It will focus the associated input and fire the onClick event.
        </p>
        <div className="space-y-2">
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates label click event. Clicking the label focuses the associated input.',
      },
    },
  },
};
...
export const RequiredState: StoryObj<typeof Label> = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Required state - shows asterisk (*) to indicate the field is required.',
      },
    },
  },
};
...
export const OptionalState: StoryObj<typeof Label> = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Optional state - shows "(optional)" text to indicate the field is optional.',
      },
    },
  },
};
