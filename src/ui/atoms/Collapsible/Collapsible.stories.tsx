...
export const Uncontrolled: StoryObj<typeof Collapsible> = {
  args: {
    ...
    trigger: (
      <div className="px-4 py-2 bg-gray-100 rounded-md">
        <Text as="span" className="font-medium">Uncontrolled Collapsible</Text>
      </div>
    ),
    children: (
      <div className="px-4 py-2">
        <Text>This collapsible uses defaultOpen and manages its own state internally.</Text>
      </div>
    ),
  },
  parameters: {
...
export const WithEvents: StoryObj<typeof Collapsible> = {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Click the trigger below. Check the Actions panel to see events being fired.
        </p>
        <Collapsible
          open={isOpen}
          ...
          trigger={
            <div className="px-4 py-2 bg-gray-100 rounded-md">
              <Text as="span" className="font-medium">Interactive Collapsible</Text>
            </div>
          }
        >
          <div className="px-4 py-2">
  ...
  play: async ({ canvasElement }) => {
    ...
    const trigger = canvas.getByText('Interactive Collapsible').closest('button') || canvas.getByRole('button');
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates collapsible events. Click the trigger and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const ClosedState: StoryObj<typeof Collapsible> = {
  args: {
    ...
    trigger: (
      <div className="px-4 py-2 bg-gray-100 rounded-md">
        <Text as="span" className="font-medium">Closed Collapsible</Text>
      </div>
    ),
    children: (
      <div className="px-4 py-2">
...
export const OpenState: StoryObj<typeof Collapsible> = {
  args: {
    ...
    trigger: (
      <div className="px-4 py-2 bg-gray-100 rounded-md">
        <Text as="span" className="font-medium">Open Collapsible</Text>
      </div>
    ),
    children: (
      <div className="px-4 py-2">
...
export const DisabledState: StoryObj<typeof Collapsible> = {
  args: {
    ...
    trigger: (
      <div className="px-4 py-2 bg-gray-100 rounded-md opacity-50">
        <Text as="span" className="font-medium">Disabled Collapsible</Text>
      </div>
    ),
    children: (
      <div className="px-4 py-2">
  ...
  parameters: {
    docs: {
      description: {
        story: 'Disabled state - collapsible is not interactive, shows reduced opacity.',
      },
    },
  },
};
