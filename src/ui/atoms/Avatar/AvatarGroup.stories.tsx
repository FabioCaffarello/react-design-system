...
export const WithMax: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Shows only 2 avatars and displays +2 overflow indicator for the remaining avatars.",
      },
    },
  },
};
...
export const WithOverflow: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Shows 3 avatars and displays +3 overflow indicator for the remaining 3 avatars.",
      },
    },
  },
};
...
export const WithOverflowState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'With overflow state - group shows overflow indicator when there are more avatars than max.',
      },
    },
  },
};
...
export const NoSpacingState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'No spacing state - avatars are displayed without spacing between them.',
      },
    },
  },
};
