...
| \`loading\` | Botão carregando | \`isLoading={true}\` | Botão com spinner, desabilitado |
  ...
  argTypes: {
    ...
    as: {
      ...
      description: 'Polymorphic prop: render as different element (e.g., Link component)',
    },
    href: {
      control: 'text',
...
export const LoadingStates: Story = {
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          ...
          <Button isLoading loadingText="Processing...">Process</Button>
        </div>
      </div>
      <div className="space-y-2">
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates different loading states: default spinner, custom loading text, and custom loading icon.',
      },
    },
  },
};
...
export const Polymorphic: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <p className="text-sm text-gray-600">Button with href (for custom Link components):</p>
        <Button as="a" href="/dashboard">
          Dashboard Link
        </Button>
      </div>
      <p className="text-xs text-gray-500">
        The `as` prop allows rendering Button as different elements, useful for Next.js Link or React Router.
      </p>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates the polymorphic `as` prop to render Button as different elements (e.g., anchor tag or custom Link component).',
      },
    },
  },
};
...
export const WithEvents: Story = {
  render: () => {
    ...
    const handleMouseEnter = fn((event: React.MouseEvent<HTMLButtonElement>) => {
      console.log('Mouse entered:', event);
    });
    
    const handleMouseLeave = fn((event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-gray-600">
          Interact with the button below. Check the Actions panel to see events being fired.
        </p>
        <Button
          onClick={handleClick}
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates all button events. Interact with the button and check the Actions panel to see events being logged.',
      },
    },
  },
};
...
export const DefaultState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default state of the button - normal appearance, ready for interaction.',
      },
    },
  },
};
...
export const HoverState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Hover state - activated when mouse enters the button area. Visual feedback shows the button is interactive.',
      },
    },
  },
};
...
export const ActiveState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Active state - activated when button is pressed and held. Shows pressed appearance.',
      },
    },
  },
};
...
export const FocusState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Focus state - activated via Tab key or programmatic focus. Shows focus outline for accessibility.',
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Disabled state - button is not interactive, shows reduced opacity and is not clickable.',
      },
    },
  },
};
...
export const LoadingState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Loading state - button shows spinner and is disabled during loading operation.',
      },
    },
  },
};
