...
export const InContext: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Real-world example showing separators dividing content sections.',
      },
    },
  },
};
...
export const HorizontalState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Horizontal state - separator divides content vertically (horizontal line).',
      },
    },
  },
};
...
export const VerticalState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Vertical state - separator divides content horizontally (vertical line).',
      },
    },
  },
};
