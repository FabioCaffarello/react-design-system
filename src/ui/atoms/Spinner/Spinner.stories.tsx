...
export const Accessibility: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <p className="text-sm text-gray-600 mb-2">Spinner with accessible label:</p>
        <Spinner label="Loading user data..." />
      </div>
      <div>
        <p className="text-sm text-gray-600 mb-2">Spinner without label (uses default):</p>
        <Spinner />
      </div>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Demonstrates accessibility features: role="status", aria-live="polite", and aria-label.',
      },
    },
  },
};
...
export const LoadingState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Loading state - spinner is animating, indicating a loading process.',
      },
    },
  },
};
