...
**Versão do Design System:** `@fabio.caffarello/react-design-system@^1.9.0` → `1.10.1`  
**Versão do Next.js:** `15.5.9`

> **⚠️ ATUALIZAÇÃO:** Este documento descreve problemas com versões anteriores. Para o bug mais recente (v1.10.1), ver:
> - **Bug Report Completo:** `DESIGN_SYSTEM_BUILD_BUG_REPORT.md`
> - **Resumo Executivo:** `DESIGN_SYSTEM_BUILD_BUG_SUMMARY.md`
> 
> **Novo Problema (v1.10.1):** `ReferenceError: Cannot access 'aT' before initialization` durante prerendering
