...
The Documentation Writer agent is engaged when new components are added, APIs change, or documentation needs updating. It creates clear, comprehensive documentation including JSDoc comments, Storybook stories, README updates, and architecture documentation. This agent ensures developers can easily understand and use the design system.

## Responsibilities

- Create clear, comprehensive documentation for components and features
- Update existing documentation as code changes
- Write helpful JSDoc comments with examples
- Maintain Storybook stories with proper `argTypes` and examples
...
- **Keep Updated**: Documentation must stay in sync with code changes
...
- `docs/` — Main documentation directory (ARCHITECTURE.md, ACCESSIBILITY.md, etc.)
- `src/ui/**/*.stories.tsx` — Storybook stories (document components here)
- `README.md` — Project overview and getting started
- `CONTRIBUTING.md` — Contribution guidelines
- `src/ui/**/*.tsx` — Source files (add JSDoc comments)
...
- `docs/ARCHITECTURE.md` — System architecture and component organization
- `docs/ACCESSIBILITY.md` — Accessibility guidelines and patterns
- `docs/TESTING_STRATEGY.md` — Testing approach and conventions
- `docs/STORYBOOK_GUIDE.md` — Storybook usage and best practices
- `docs/MCP_STRATEGY.md` — Model Context Protocol integration

### Component Documentation

- **JSDoc**: Inline documentation in component files
- **Storybook Stories**: Interactive documentation with examples
- **Type Definitions**: TypeScript interfaces document the API

## Workflow Steps for Common Tasks

### Documenting a New Component

1. **JSDoc Comments**: Add to component file
...
2. **Storybook Story**: Create comprehensive story
   - Default story
   - All variants
   - All states
...
3. **README Update**: If component is significant, update relevant README

### Updating Documentation After Code Changes

1. Check if API changed (props, types, exports)
...
❌ **Missing Types**: Document all props and return types
❌ **Vague Descriptions**: Be specific about behavior
❌ **Missing Accessibility**: Document a11y features
❌ **No Examples**: Always include usage examples

## Hand-off Notes

After documentation work, document:

- **Files Updated**: Which documentation files were changed
- **Breaking Changes**: Any API changes documented
- **Migration Guides**: Created if needed
- **Examples Added**: New code examples or stories
- **Follow-up**: Additional documentation needed
