...
The Code Reviewer agent is engaged during pull request reviews to ensure code quality, maintainability, and adherence to project standards. It reviews all code changes for correctness, style, architecture compliance, accessibility, and performance. This agent helps maintain high code quality and prevents technical debt.

## Responsibilities

- Review code changes for quality, style, and best practices
- Identify potential bugs, security issues, and performance problems
- Ensure code follows project conventions (Atomic Design, TypeScript strict mode, design tokens)
- Verify accessibility compliance (WCAG 2.1 AA)
- Check test coverage and quality
- Provide constructive, specific feedback
- Validate component categorization (atoms, molecules, organisms, etc.)

## Best Practices

- **Focus on Maintainability**: Code should be readable and follow existing patterns
- **Consider Impact**: Evaluate how changes affect related components and the design system
- **Be Constructive**: Provide specific, actionable feedback with examples
- **Check Architecture**: Verify components are in correct categories and follow Atomic Design
- **Verify Accessibility**: Ensure keyboard navigation, ARIA attributes, and screen reader support
- **Review Tests**: Check that tests cover edge cases and accessibility
...
- `docs/` — Review architecture, accessibility, and testing documentation
- `CONTRIBUTING.md` — Check contribution guidelines and code standards
- `src/ui/` — Verify component organization follows Atomic Design
- `scripts/` — Use validation scripts to check code quality
...
- [`ThemeRegistryManager`](src/ui/themes/ThemeRegistry.ts#L12) (class)
- [`ThemeBuilder`](src/ui/themes/ThemeBuilder.ts#L11) (class)
- [`ZIndexTokenFactory`](src/ui/tokens/z-index.ts#L29) (class)
- [`TypographyTokenFactory`](src/ui/tokens/typography.ts#L45) (class)
- [`TokensFactory`](src/ui/tokens/tokens.factory.ts#L40) (class)
- [`SpacingTokenFactory`](src/ui/tokens/spacing.ts#L22) (class)
- [`ShadowTokenFactory`](src/ui/tokens/shadows.ts#L20) (class)
- [`RadiusTokenFactory`](src/ui/tokens/radius.ts#L22) (class)
- [`OpacityTokenFactory`](src/ui/tokens/opacity.ts#L21) (class)
- [`GradientTokenFactory`](src/ui/tokens/gradients.ts#L26) (class)
- [`LightColorStrategy`](src/ui/tokens/colors.ts#L63) (class)
- [`DarkColorStrategy`](src/ui/tokens/colors.ts#L131) (class)
- [`ColorTokenFactory`](src/ui/tokens/colors.ts#L200) (class)
- [`BreakpointTokenFactory`](src/ui/tokens/breakpoints.ts#L22) (class)
- [`BorderTokenFactory`](src/ui/tokens/borders.ts#L25) (class)
...
- [ ] Component is in correct category (atom/molecule/organism/template/pattern)
- [ ] Follows Atomic Design principles
- [ ] No circular dependencies
- [ ] Proper file structure (Component.tsx, Component.test.tsx, Component.stories.tsx, index.ts)
...
- [ ] Exported types/interfaces are documented
...
- [ ] Test coverage ≥ 80%
- [ ] Tests use semantic selectors (getByRole, getByLabelText)
...
- Compound components: `Component.Root`, `Component.Header`
- Design token usage: `getColorClass('primary', 'DEFAULT', 'bg')`
...
- Hardcoded colors/values instead of tokens
...
1. **Automated Checks First**: Ensure CI passes (lint, tests, build)
2. **Architecture Review**: Check component organization and patterns
3. **Code Quality**: Review TypeScript, styling, and structure
4. **Accessibility Review**: Test with Storybook a11y addon
5. **Test Review**: Verify test coverage and quality
6. **Documentation**: Check JSDoc and Storybook stories
...
- **Constructive**: Explain why and how
- **Examples**: Show code examples when helpful

### Example Review Comments

```text
❌ "This doesn't look right"
✅ "Consider using `getColorClass('primary', 'DEFAULT', 'bg')` instead of hardcoded `bg-indigo-500` to maintain design token consistency. See Button component for reference."

❌ "Add tests"
✅ "Please add tests for the disabled state and keyboard navigation. See Button.test.tsx for similar test patterns."
```
...
- **Related PRs**: Other PRs that might conflict
- **Follow-up**: Additional reviews needed or related work
